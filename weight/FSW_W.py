...
if __name__=='__main__':
    ...
    while(max_error <=0.5):
        ...
        for i in range(len(segList_FSW)):
            segList_FSW[i] = segList_FSW[i] * std_TS_volume + mean_TS_volume
...
# =============================================================================
    ...
    np.savetxt('E:/论文/论文初写/code/output/CSIW/CSIW_FSW.txt',list_ans,fmt='%.4f')                    
